...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference("Warehouse.count") do
      post warehouses_url, params: { warehouse: { active: @warehouse.active, address: @warehouse.address, city_id: @warehouse.city_id, name: @warehouse.name } }, as: :json
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { active: @warehouse.active, address: @warehouse.address, city_id: @warehouse.city_id, name: @warehouse.name } }, as: :json
    assert_response :success
  end
